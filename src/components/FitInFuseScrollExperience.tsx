      ...
      <div ref={trackRef} className="relative h-[650vh] w-full">
        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between">
          ...
          <div 
            ...
            className="relative z-20 flex-1 w-full h-full pt-[62px] sm:pt-20 pb-2 sm:pb-4 px-2 sm:px-8 flex items-start sm:items-center justify-center pointer-events-none"
          >
